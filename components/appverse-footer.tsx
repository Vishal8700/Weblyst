...
const defaultContent: FooterContent = {
  tagline: "Experience in online marketing & Web development with experienced developers across all domain.",
  copyright: "© 2025 — Weblyst India & International ",
}
          ...
          <div className="grid gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xl font-semibold text-white">Weblyst</span>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-2">
              <div>
                ...
                <ul className="space-y-2 text-sm text-neutral-300">
                  {["Home", "Features", "Testimonials", "Blog", "Download"].map((item) => (
                    <li key={item}>
